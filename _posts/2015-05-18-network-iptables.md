...
<div class="message">
This time, I get to have fun with configuring a <a url="https://www.raspberrypi.org/">Raspberry Pi</a> with <a url="https://www.raspbian.org/">Raspbian</a> to limit its network accessibility to meet our security compliances.
</div>
